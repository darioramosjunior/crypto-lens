...
$cron_schedule $SERVICE_USER ${VENV_DIR}/bin/python3 $script_path >> $log_file 2>&1
EOF
...
main() {
    ...
    echo "  3. Monitor logs: tail -f /var/log/crypto-lens/*.log"
    echo "  4. Test the application manually: source $VENV_DIR/bin/activate && python3 $APP_DIR/main.py"
    echo ""
}
